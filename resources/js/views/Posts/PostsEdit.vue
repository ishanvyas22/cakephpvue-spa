        ...
        >
            <fieldset>
                ...
                <div
                    ...
                    v-bind:class="{ error: errors.has('title') }"
                >
                ...
                <div
                    ...
                    v-bind:class="{ error: errors.has('description') }"
                >
                ...
                <button
                    type="submit"
                    class="button radius shadow primary"
                    :disabled="errors.any()"
                >
                    Submit
                </button>
                ...
                <a
                    class="button shadow radius right mr-6"
                    name="goBack"
...
export default {
    ...
    mounted() {
        ...
        this.getPost(this.$route.query);
    },
    methods: {
        getPost(query) {
            axios
                .get(`/api/posts/edit/${this.id}`, { params: query })
                .then((response) => {
        ...
        onSubmit(event) {
            ...
            axios
                .post(`/api/posts/update/${this.id}`, data, {
